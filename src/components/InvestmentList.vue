...
+ investment.pk"
        ...
        <div :id="'collapse' + investment.pk" class="collapse" :aria-labelledby="'heading' +
investment.pk"
          ...
          <div class="card-body">
            ...
            <div class="btn-group">
              <button @click="updateInvestment(investment)" style="background-color: transparent; padding: 5px;">
                <font-awesome-icon icon="pencil"/>
              </button>
              <button @click="deleteInvestment(investment)" style="background-color: transparent; padding: 5px;">
...
padding: 0;">
      ...
      <button type="button" class="btn btn-primary" @click="addNewInvestment">Add New
        Investment
      </button>
    </div>
  </div>
