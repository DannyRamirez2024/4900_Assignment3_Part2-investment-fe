                ...
                <form ref="form">
                  <div class="container-fluid">
                    ...
                    <div class="form-group row justify-content-around py-2">
                      ...
                      <div class="col col-8">
                        <input v-model="investment.acquired_value" type="number" class="form-control-sm form-
control">
                      </div>
                    </div>
                    <div class="form-group row justify-content-around py-2">
                      ...
                      <div class="col col-8">
                        <input v-model="investment.acquired_date" type="date" class="form-control-sm form-
control">
                      </div>
                    </div>
                    <div class="form-group row justify-content-around py-2">
                      ...
                      <div class="col col-8">
                        <input v-model="investment.recent_value" type="number" class="form-control-sm form-
control">
                      </div>
                    </div>
                    <div class="form-group row justify-content-around py-2">
