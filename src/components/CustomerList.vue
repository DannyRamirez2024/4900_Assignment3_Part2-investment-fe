...
customer.pk"
        ...
        <div :id="'collapse' + customer.pk" class="collapse" :aria-labelledby="'heading' + customer.pk"
          ...
          <div class="card-body">
            ...
            <div v-if="(this.userID === customer.agent || this.is_superuser === 'true')" class="btn-
group">
              <button @click="updateCustomer(customer)" style="background-color: transparent; padding: 5px;">
                <font-awesome-icon icon="pencil"/>
              </button>
              <button @click="deleteCustomer(customer)" style="background-color: transparent; padding: 5px;">
      ...
      <table class="table table-hover" style="overflow-y: auto"
        ...
        <tr v-for="customer in customers" v-bind:key="customer">
          ...
          <td v-if="(this.userID === customer.agent || this.is_superuser === 'true')"
            ...
            <button style="background-color: transparent; padding: 5px;">
              <font-awesome-icon icon="pencil"/>
            </button>
          </td>
          <td v-else>
